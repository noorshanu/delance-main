        ...
        <div className="team-grid">
          ...
          <div className="team-box">
            <div className="linked">
              <a
                className="linked-in"
                href="https://www.linkedin.com/in/roberto-cinque/"
                target="_blank"
                rel="noreferrer"
              >
                <FaLinkedin />{" "}
            ...
            <div className="team_details">
              <p>
                ...
                several companies worldwide. Building websites, crypto coins and
                tokens, exchange platforms, defi platforms, NFT related
          ...
          <div className="team-box">
            <div className="linked">
              <a
                className="linked-in"
                href="https://www.linkedin.com/in/suhaibt/"
                target="_blank"
                rel="noreferrer"
              >
                <FaLinkedin />{" "}
            ...
            <div className="team_details">
              <p>
                ...
                .Highlighted by consistent success, validated by tangible KPIs,
                with a demonstrated history of working across traditional and
                digital sets. He a creative mind working alongside a superior
                team, on course to deliver a project that exceeds all
                expectations .
              </p>
            </div>
          </div>
          ...
          <div className="team-box">
            <div className="linked">
              <a
                className="linked-in"
                href="https://www.linkedin.com/in/deeba-965b49121"
                target="_blank"
                rel="noreferrer"
              >
                <FaLinkedin />{" "}
            ...
            <div className="team_details">
              <p>
                Communication and content expert ,with over 7years experience in
                Marketing and Business Development. she is innovator fascinated
                with Potential of blockchain. Debba has unique abilities and is
                an excellent individual with special- Mindset that distinguishes
                from the crowd .
              </p>
            </div>
          </div>
          ...
          <div className="team-box">
            <div className="linked">
              <a
                className="linked-in"
                href="https://www.linkedin.com/in/adnan-a-rahi-9a2573216/"
                target="_blank"
                rel="noreferrer"
              >
                <FaLinkedin />{" "}
            ...
            <div className="team_details">
              <p>
                ...
                assignments since three years , thought-out I build and secured
                tokens , launchpad’s , defi and other web3 applications .
              </p>
            </div>
          </div>
          ...
          <div className="team-box">
            <div className="linked">
              <a
                className="linked-in"
                href="https://www.linkedin.com/in/dommeti-k-329235257/"
                target="_blank"
                rel="noreferrer"
              >
                <FaLinkedin />{" "}
          ...
          <div className="team-box">
            <div className="linked">
              <a
                className="linked-in"
                href="https://www.linkedin.com/in/gurpreetsingh993/"
                target="_blank"
                rel="noreferrer"
              >
                <FaLinkedin />{" "}
          ...
          <div className="team-box">
            <div className="linked">
              <a
                className="linked-in"
                href="https://www.linkedin.com/in/noor-alam-aa722314b/"
                target="_blank"
                rel="noreferrer"
              >
                <FaLinkedin />{" "}
            ...
            <div className="team_details">
              <p>
                ...
                working in all kind of platforms , ha has very strong background
                and expertise in React , NodeJs and phyton he is a great team
          ...
          <div className="team-box">
            <div className="linked">
              <a
                className="linked-in"
                href="https://www.linkedin.com/in/visakh-john-thykoodan-8b4709172/"
                target="_blank"
                rel="noreferrer"
              >
                <FaLinkedin />{" "}
          ...
          <div className="team-box">
            ...
            <div className="text-center box-img">
              <img src="images/abdullah-mehboob.jpeg" alt="" />
              <h2>ABDULLAH MEHBOOB</h2>
              <p>FRONTEND DEVELOPER</p>
            </div>
            <div className="team_details">
              <p>
                Abdullah Mehboob is an experienced frontend developer with over
                four years of expertise in the field. He possesses a strong
                knowledge of technology trends and is skilled in using a variety
                of tools and frameworks, such as Reactjs, Nextjs, Tailwindcss,
                Chakra UI, and More. Abdullah's proficiency in these
                technologies makes him a valuable asset to any team he works
                with.
              </p>
            </div>
          </div>
