  ...
  return (
    ...
    <div className="container">
      ...
      <p>
        ...
        https://deelance.com/    will make the ultimate decisions about the interpretation and modification of
        this program. https://deelance.com/    reserves the right, at its sole discretion, to alter the specifics of
        the program at any time and without advance notification to the users. If there is a
        change, it will be posted on the https://deelance.com/    website right away. https://deelance.com/    asks that you
        check our website for the most recent information. You are considered to have agreed to
        and accepted https://deelance.com/'s modifications to the program specifics if you continue to
        ...
        https://deelance.com/    retains the right to expel from the platform any users who are proven or
        ...
        the moniker "https://deelance.com/ " for illicit purposes will be held responsible for their actions.
        profits.</p>
        </div>
        </div>
</section>
